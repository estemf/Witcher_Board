...
const populate = () => {
    [
        ...
        },
        {
            ...
            description: "Villagers from Duskwood have been vanishing without a trace.\nStrange howls are heard at night, and those who wander too close to the abandoned chapel never return.\nThe local alderman offers a hefty sum for solving the mystery.",
            reward: "500 Crowns and a rare alchemical formula",
        },
    ].forEach((contract) => (0, contractRepository_1.addContract)(contract));
    (0, contractRepository_1.assignContract)(2, 2);
    (0, contractRepository_1.assignContract)(3, 1);
    (0, contractRepository_1.completeContract)(2);
};
